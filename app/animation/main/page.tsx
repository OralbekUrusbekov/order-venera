...
import { DroneModel } from "@/app/animation/components/drone-model"
      ...
      <header className="absolute top-0 left-0 right-0 z-20 px-8 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => router.push("/")}
              className="px-3 py-1 rounded-md border border-border bg-background/80 backdrop-blur text-sm hover:bg-accent transition"
            >
              ← Артқа
            </button>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Планетаға қону және жер қазу операциясы
              </p>
            </div>
          </div>

          <div className="text-sm text-muted-foreground">
            Модельді бұрау үшін тышқанды басып ұстаңыз
          </div>
        </div>
      </header>
